...
public class PerpetualConditionOrderFunctionServiceImpl implements FunctionService {
  ...
  public List<ReplyBean> replyUserMessage(AskBean askBean, JSONArray data) {
    ...
    for (Object obj : data) {
      ...
      // message.put("avgPrice",
      // BigDecimalSerializerUtil.serializer(json.getBigDecimal("avgPrice")));
      // message.put("dealAmount",
      // BigDecimalSerializerUtil.serializer(json.getBigDecimal("dealAmount")));
      message.put("direction", json.getString("direction"));
      message.put("triggerBy", json.getString("type"));
      message.put("triggerPrice",
          BigDecimalSerializerUtil.serializer(json.getBigDecimal("conditionPrice")));
      ...
      message.put("profit", "0");
      message.put("fee", "0");
      message.put("reason", 0);
