package cc.newex.dax.market.spider.common.util.bibox;
 ...
 */
@Slf4j
public class BiBoxUtil {
    public static LatestTicker biBoxBuildTicker(final String json) {
        try {
            final JSONObject jsonObject = JSON.parseObject(json).getJSONObject("result");
