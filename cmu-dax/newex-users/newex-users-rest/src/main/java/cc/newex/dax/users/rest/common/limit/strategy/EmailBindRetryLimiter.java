...
import cc.newex.dax.users.rest.common.limit.provider.EmailBindRateLimitParameterProvider;
...
@Slf4j
@Component
public class EmailBindRetryLimiter extends AbstractRetryLimiter implements RetryLimiter {
    @Autowired
    private EmailBindRateLimitParameterProvider provider;
