...
import cc.newex.dax.users.rest.common.limit.provider.ApiSecretRateLimitParameterProvider;
...
@Slf4j
@Component
public class ApiSecretRetryLimiter extends AbstractRetryLimiter implements RetryLimiter {
    @Autowired
    private ApiSecretRateLimitParameterProvider provider;
