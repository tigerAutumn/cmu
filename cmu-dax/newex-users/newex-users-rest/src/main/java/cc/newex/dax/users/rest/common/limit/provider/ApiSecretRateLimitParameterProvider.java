...
@Slf4j
@Component
public class ApiSecretRateLimitParameterProvider
    ...
    private final static String RATE_LIMIT_KEY_PREFIX = "newex:users:retry-limit:api-secrets:";
    ...
    protected String getRateLimitKey(final Type targetType,
        ...
        log.debug("newex:users:retry-limit:api-secrets:{}", key);
