...
import cc.newex.dax.users.rest.common.limit.provider.GoogleCodeBindRateLimitParameterProvider;
...
@Slf4j
@Component
public class GoogleCodeBindRetryLimiter extends AbstractRetryLimiter implements RetryLimiter {
    @Autowired
    private GoogleCodeBindRateLimitParameterProvider provider;
