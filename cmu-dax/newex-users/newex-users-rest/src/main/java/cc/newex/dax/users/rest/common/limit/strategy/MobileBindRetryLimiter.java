...
import cc.newex.dax.users.rest.common.limit.provider.MobileBindRateLimitParameterProvider;
...
@Slf4j
@Component
public class MobileBindRetryLimiter extends AbstractRetryLimiter implements RetryLimiter {
    @Autowired
    private MobileBindRateLimitParameterProvider provider;
