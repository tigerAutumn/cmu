...
@Slf4j
@Component
public class EnableValidateRateLimitParameterProvider
    ...
    private final static String RATE_LIMIT_KEY_PREFIX = "newex:users:retry-limit:enable-validate:";
    ...
    protected String getRateLimitKey(final Type targetType,
        ...
        log.debug("newex:users:retry-limit:enable-validate:{}", key);
