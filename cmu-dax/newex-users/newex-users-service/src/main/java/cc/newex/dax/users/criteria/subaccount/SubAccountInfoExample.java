...
//
//import cc.newex.dax.users.domain.subaccount.SubAccountInfo;
//
...
// */
//public class SubAccountInfoExample {
...
//    }
//
//    public static SubAccountInfoExample toExample(final SubAccountInfo subAccountInfo) {
//        if (Objects.isNull(subAccountInfo)) {
//            return null;
//        }
//
//        final SubAccountInfoExample example = new SubAccountInfoExample();
//        final SubAccountInfoExample.Criteria criteria = example.createCriteria();
//
//        if (Objects.nonNull(subAccountInfo.getId())) {
//            criteria.andIdEqualTo(subAccountInfo.getId());
//        }
//
//        if (Objects.nonNull(subAccountInfo.getParentId())) {
//            criteria.andParentIdEqualTo(subAccountInfo.getParentId());
//        }
//
//        if (Objects.nonNull(subAccountInfo.getUserId())) {
//            criteria.andUserIdEqualTo(subAccountInfo.getUserId());
//        }
//
//        if (Objects.nonNull(subAccountInfo.getOptType())) {
//            criteria.andOptTypeEqualTo(subAccountInfo.getOptType());
//        }
//
//        return example;
//    }
