...
var EventCommon = {
    baseUrl: BossGlobal.ctxPath + '/v1/boss/admin/events/',
...
var EventMVC = {
    URLs: {
        list: {
            url: EventCommon.baseUrl + 'listByPage',
            method: 'GET'
        },
        remove: {
    ...
    View: {
        initControl: function () {
            ...
            var pager = $("#event-datagrid").datagrid("getPager");
            if (pager) {
                $(pager).pagination({
                    onSelectPage: function (pageNumber, pageSize) {
                        var url = EventMVC.Controller.getSearchUrl();
                        $("#event-datagrid").datagrid({
    ...
    Controller: {
        ...
        getSearchUrl: function () {
            ...
            return url = EventMVC.URLs.list.url + '?fieldName=' + fieldName + '&keyword=' + keyword;
        },
        find: function () {
            var url = EventMVC.Controller.getSearchUrl();
            $("#event-datagrid").datagrid({
