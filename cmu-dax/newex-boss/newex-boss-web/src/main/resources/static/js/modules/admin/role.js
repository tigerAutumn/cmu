...
var RoleCommon = {
    baseUrl: BossGlobal.ctxPath + '/v1/boss/admin/roles/',
...
var RoleMVC = {
    URLs: {
        ...
        list: {
            url: RoleCommon.baseUrl + 'listByPage',
            method: 'GET'
        },
        remove: {
        ...
        getBrokerList: {
            url: RoleCommon.brokerBaseUrl + 'list'
        }
    },
    View: {
        initControl: function () {
            ...
            $("#brokerId").combobox({
                url: RoleMVC.URLs.getBrokerList.url,
                method: 'get',
                valueField: "id",
            ...
            if (pager) {
                $(pager).pagination({
                    onSelectPage: function (pageNumber, pageSize) {
                        var url = RoleMVC.Controller.getSearchUrl();
                        $("#role-datagrid").datagrid({
    ...
    Controller: {
        ...
        getSearchUrl: function () {
            ...
            return url = RoleMVC.URLs.list.url + '?fieldName=' + fieldName + '&keyword=' + keyword;
