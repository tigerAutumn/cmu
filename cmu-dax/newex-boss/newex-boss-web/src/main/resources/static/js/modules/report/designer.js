...
var DesignerCommon = {
    baseUrl: BossGlobal.ctxPath + '/v1/boss/report/designer/',
    baseHistoryUrl: BossGlobal.ctxPath + '/v1/boss/report/history/',
    baseDsUrl: BossGlobal.ctxPath + '/v1/boss/report/data-sources/',
    baseIconUrl: BossGlobal.ctxPath + '/custom/easyui/themes/icons/',
    baseReportUrl: BossGlobal.ctxPath + '/report/'
};
...
var DesignerMVC = {
    URLs: {
        ...
        list: {
            url: DesignerCommon.baseUrl + 'listByPage',
            method: 'GET'
        },
        find: {
