...
var PermCommon = {
    baseUrl: BossGlobal.ctxPath + '/v1/boss/admin/permissions/',
    baseModuleUrl: BossGlobal.ctxPath + '/v1/boss/admin/modules/',
...
var PermMVC = {
    URLs: {
        ...
        list: {
            url: PermCommon.baseUrl + 'listByPage',
            method: 'GET'
        },
        remove: {
    ...
    Controller: {
        ...
        save: function () {
            ...
            var options = {
                ...
                url: actUrl,
                callback: function () {
                    PermMVC.Controller.refreshNode(moduleId);
