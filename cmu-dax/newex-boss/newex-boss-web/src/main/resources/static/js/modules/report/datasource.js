...
var DsCommon = {
    baseUrl: BossGlobal.ctxPath + '/v1/boss/report/data-sources/',
    baseConfUrl: BossGlobal.ctxPath + '/v1/boss/report/conf/',
...
var DsMVC = {
    URLs: {
        ...
        list: {
            url: DsCommon.baseUrl + 'listByPage',
            method: 'GET'
        },
        remove: {
        ...
        initControl: function () {
            ...
            $('#dbType').combobox({
                onSelect: function (record) {
                    var item = DsMVC.Model.dbTypes[record.value].value;
            ...
            $('#dbPoolType').combobox({
                onSelect: function (record) {
                    var item = DsMVC.Model.dbPoolTypes[record.value].value;
