...
public class JobLogController {
	...
	public ReturnT<String> logKill(int id){
		...
		if (ReturnT.SUCCESS_CODE != xxlJobLog.getTriggerCode()) {
		...
		try {
			ExecutorBiz executorBiz = XxlJobDynamicScheduler.getExecutorBiz(xxlJobLog.getExecutorAddress());
		...
		if (ReturnT.SUCCESS_CODE == runResult.getCode()) {
			...
			xxlJobLog.setHandleMsg( I18nUtil.getString("joblog_kill_log_byman")+":" + (runResult.getMsg()!=null?runResult.getMsg():""));
