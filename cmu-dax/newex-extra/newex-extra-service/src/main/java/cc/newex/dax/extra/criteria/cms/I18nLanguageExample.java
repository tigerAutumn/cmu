 ...
 * @date 2018-05-30
 */
public class I18nLanguageExample {
    ...
    public static I18nLanguageExample toExample(final I18nLanguage i18nLanguage) {
        if (i18nLanguage == null) {
            return null;
        }

        final I18nLanguageExample example = new I18nLanguageExample();
        final I18nLanguageExample.Criteria criteria = example.createCriteria();

        if (Objects.nonNull(i18nLanguage.getId())) {
            criteria.andIdEqualTo(i18nLanguage.getId());
        }

        if (StringUtils.isNotBlank(i18nLanguage.getCode())) {
            criteria.andCodeEqualTo(i18nLanguage.getCode());
        }

        if (StringUtils.isNotBlank(i18nLanguage.getName())) {
            criteria.andNameLike(i18nLanguage.getName());
        }
