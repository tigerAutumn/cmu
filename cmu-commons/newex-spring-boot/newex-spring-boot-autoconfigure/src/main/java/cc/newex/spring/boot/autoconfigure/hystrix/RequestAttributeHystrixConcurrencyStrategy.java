...
public class RequestAttributeHystrixConcurrencyStrategy extends HystrixConcurrencyStrategy {
    ...
    private void logCurrentStateOfHystrixPlugins(final HystrixEventNotifier eventNotifier,
                                                 final HystrixMetricsPublisher metricsPublisher,
                                                 final HystrixPropertiesStrategy propertiesStrategy) {
    ...
    static class WrappedCallable<T> implements Callable<T> {
        ...
        public WrappedCallable(final Callable<T> target, final RequestAttributes requestAttributes) {
            this.target = target;
