package cc.newex.spring.boot.autoconfigure.fileupload;
...
public abstract class AbstractFileUploadProperties {
     ...
     * (如：http://vpc-100.oss or s3-cn-hangzhou.aliyuncs.com)
     *
     * @return vpc endpoint
     */
    ...
    /**
     * 获取具体上传的oss or s3 endpoint地址(如：http://oss or s3-cn-hangzhou.aliyuncs.com）
     *
