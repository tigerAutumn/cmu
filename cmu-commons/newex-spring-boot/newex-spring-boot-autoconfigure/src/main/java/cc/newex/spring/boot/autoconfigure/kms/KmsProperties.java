package cc.newex.spring.boot.autoconfigure.kms;

import org.springframework.boot.context.properties.ConfigurationProperties;

@ConfigurationProperties("newex.kms")
public class KmsProperties {
    ...
    public static class KmsPolicy {
        /**
         * 基于 @see {@link org.springframework.cloud.config.environment.PropertySource} 实现配置项解密
         */
