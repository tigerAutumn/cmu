...
public class BitConvertUtil {
    ...
    public static String bytesToHexString(final byte[] src, final String sperator) {
        ...
        for (int i = 0; i < src.length; i++) {
            ...
            stringBuilder.append(hv).append(sperator);
        }
    ...
    public static void main(final String... args) {
        final long value = 2;
        System.out.println(getBitString(value));
        System.out.println(getBitString(setBitValue(value, 11, 1234)));
    }
}
