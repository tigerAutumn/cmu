...
public class JwtPublicClaims {
    ...
    public final static String BROKER_ID = "bid";
    ...
    public Integer getBrokerId() {
        return this.claims.get(JwtPublicClaims.BROKER_ID, Integer.class);
    }

    public JwtPublicClaims setBrokerId(final Integer brokerId) {
        this.claims.put(JwtPublicClaims.BROKER_ID, brokerId);
        return this;
    }
