...
//            currency = CurrencyEnum.ACT;
//        }
        currency = CurrencyEnum.toMainCurrency(currency);
        for (final Map.Entry<String, ISignService> entry : SignContent.cache.entrySet()) {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        SignContent.cache = this.context.getBeansOfType(ISignService.class);
